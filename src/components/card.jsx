...
export default function Cards() {
    ...
    return (
        <div className="w-full max-w-sm p-4 bg-transparent border border-[#800080] rounded-lg shadow-sm sm:p-6 dark:bg-gray-800/40 dark:border-[#800080]">
            <h5 className="mb-3 font-[Mochiy_Pop_One] font-extralight text-gray-900 md:text-xl dark:text-[#e11d48] text-center">
                Masukan Address
            </h5>
            {/* Input */}
            <form>
                <label htmlFor="address" className="mb-2 font-[Mochiy_Pop_One] text-sm font-medium text-gray-900 sr-only dark:text-white">
                    Your Address
                </label>
                <div className="relative">
                    <div className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                        <svg className="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                            <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M2 6h12a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2H2m0-8V4a2 2 0 0 1 2-2h8l4 4v8m-4-6H4"/>
                        </svg>
                    </div>
                    <input
                        type="text"
                    ...
                    <motion.button
                        ...
                        className={`text-white absolute end-2.5 bottom-2.5 bg-[#DA1C46] hover:bg-[#a76977] focus:ring-4 focus:outline-none focus:ring-[#800080] font-medium rounded-lg text-sm px-4 py-2 dark:bg-[#DA1C46] dark:hover:bg-[#a76977] dark:focus:ring-[#800080] ${
                            clicked ? "border-[#800080] shadow-lg scale-95" : ""
                        }`}
                    >
            ...
            <h5 className="mb-3 text-base font-semibold text-gray-900 md:text-xs dark:text-white text-center">
                OR
            </h5>
